...
const TermsAndConditionsPage = () => {
  return (
    <div className="termsandconditionspage">
      <HeaderDesktop1 />
      <section className="terms-and-conditions-parent">
